			...
			try {
				...
				if (checkBounds(thisEdge.destination.x, thisEdge.destination.y)) {
					if (!(visited[thisEdge.destination.x][thisEdge.destination.y])) {
						...
						newEdge = new Edge(new Point(thisEdge.destination.x, thisEdge.destination.y), new Point(thisEdge.destination.x+1, thisEdge.destination.y), weight + thisEdge.weight);
						eQueue.add(newEdge);
						// @param for the North-Eastern Node
						weight = floatImages[1].get_nocheck(thisEdge.destination.x, thisEdge.destination.y);
						newEdge = new Edge(new Point(thisEdge.destination.x, thisEdge.destination.y), new Point(thisEdge.destination.x+1, thisEdge.destination.y+1), weight + thisEdge.weight);
						eQueue.add(newEdge);
						// @param for the Northern Node
						weight = floatImages[2].get_nocheck(thisEdge.destination.x, thisEdge.destination.y);
						newEdge = new Edge(new Point(thisEdge.destination.x, thisEdge.destination.y), new Point(thisEdge.destination.x, thisEdge.destination.y+1), weight + thisEdge.weight);
						eQueue.add(newEdge);
						// @param for the North Western Node
						weight = floatImages[3].get_nocheck(thisEdge.destination.x, thisEdge.destination.y);
						newEdge = new Edge(new Point(thisEdge.destination.x, thisEdge.destination.y), new Point(thisEdge.destination.x-1, thisEdge.destination.y+1), weight + thisEdge.weight);
						eQueue.add(newEdge);
					}
